...
class KubeCreateCustomTemplateViewController {
  /* @ngInject */
  constructor($async, $state, CustomTemplateService, ModalService, Notifications) {
    Object.assign(this, { $async, $state, CustomTemplateService, ModalService, Notifications });
  ...
  async createCustomTemplate() {
    return this.$async(async () => {
      ...
      try {
        await this.createCustomTemplateByMethod(method, this.formValues);
